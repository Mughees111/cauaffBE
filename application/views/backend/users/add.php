                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group <?=(form_error('name') !='')?'error':'';?>">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" class="form-control" required data-validation-required-message="This field is required" placeholder="First Name" value="<?php if(set_value('name') != ''){ echo set_value('name');}else echo $prev->name;?>" >
                    ...
                    <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group <?=(form_error('password') !='')?'error':'';?>">
                                    <h5>Password :  <small> <i class="fa fa-info"></i> This password will be sent to this user's email address </small><span class="text-danger">*</span></h5>
                                    <div class="controls">
                                        <input type="text" name="password" class="form-control" required data-validation-required-message="This field is required" 



                                         data-validation-regex-regex="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&*-]).{8,}$" data-validation-regex-message="password must contain at least eight characters, at least one number and both lower and uppercase letters and special characters"


                                        placeholder="Password" value="<?php if(set_value('password') != ''){ echo set_value('password');}else echo $prev->password;?>" >
